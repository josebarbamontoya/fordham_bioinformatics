...
wget https://raw.githubusercontent.com/josebarbamontoya/fordham_bioinformatics/main/class_06/fasta_alignments.zip
...
### edit sequence names part 02 (unix and mac)
...
### edit sequence names part 03 (unix and mac)
#sed -i ".bak" 's/_R_//g' *.fasta

### edit sequence names part 03 (linux)
sed -i.bak 's/_R_//g' *.fasta
...
### download fasta_alignments.zip file from github
wget https://raw.githubusercontent.com/josebarbamontoya/fordham_bioinformatics/main/class_06/mammal_genome_statistics.csv
...
wget https://raw.githubusercontent.com/josebarbamontoya/fordham_bioinformatics/main/class_06/raxml_info_files.zip

### uncompress `raxml_info_files.zip` using `unzip`
unzip raxml_info_files.zip

### change to raxml_info_files directory
cd raxml_info_files 

### extract likelihood from raxml info files
grep "final GAMMA-based Likelihood:" RAxML_info.full_aln* > raxml_tree_likelihoods.txt
...
wget https://raw.githubusercontent.com/josebarbamontoya/fordham_bioinformatics/main/class_06/mcmc_posterior_samples.zip

### uncompress `mcmc_posterior_samples.zip` using `unzip`
unzip mcmc_posterior_samples.zip
...
echo -e '#!/bin/bash\ncat f01.txt f02.txt f03.txt > my_pets.txt' > my_script.sh
